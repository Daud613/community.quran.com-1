namespace :one_time do
  ...
  task import_maududi_tafseer: :environment do
    PaperTrail.enabled = false
  ...
  task import_musfata_khitab_with_footnote: :environment do
    ...
    footnote_resource_content = ResourceContent.where({
                                                          ...
                                                          resource_type: "content",
                                                          sub_type: "footnote",
                                                          name: 'Dr. Mustafa Khattab, The Clear footnotes(With Tafsir)',
                                                          description: 'Dr. Mustafa Khattab, The Clear footnotes(With Tafsir)',
                                                          cardinality_type: "1_ayah",
                                                          language_id: language.id,
                                                          language_name: "english",
                                                          data_source: data_source,
